...
# that an instance is receiving a specific message.
  ...
  #let(:valid_attributes) { { "user_email" => "MyString" } }
...
describe MessagesController do
  describe "#destroy" do
    ...
    message = Message.create!("user_email" => "MyString")
    expect {
  ...
  describe "AjaxMessage#destroy" do
    it "should be success" do
    message = Message.create!("user_email" => "MyString")
    expect {
      delete :destroy, format: json, {:id => message.to_param}
    }.to change(Message, :count).by(-1)
   end
 end
end
...
#         post :create, {:message => { "user_email" => "invalid value" }}, valid_session
#         assigns(:message).should be_a_new(Message)
#       end
...
#         Message.any_instance.should_receive(:update).with({ "user_email" => "MyString" })
#         put :update, {:id => message.to_param, :message => { "user_email" => "MyString" }}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Message.any_instance.stub(:save).and_return(false)
#         put :update, {:id => message.to_param, :message => { "user_email" => "invalid value" }}, valid_session
#         assigns(:message).should eq(message)
#       end
